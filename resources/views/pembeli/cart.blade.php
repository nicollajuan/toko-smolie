...
<nav class="navbar navbar-light bg-white shadow-sm mb-4">
    <div class="container-fluid px-4 px-lg-5">
        {{-- TOMBOL KEMBALI DINAMIS (KASIR / PEMBELI) --}}
                            ...
                            @else
                                <tr>
                                    <td colspan="6" class="text-center py-5 text-muted">
                                        ...
                                        {{-- TOMBOL BELANJA DINAMIS (KASIR / PEMBELI) --}}
                                        @if(Auth::check() && in_array(Auth::user()->usertype, ['admin', 'kasir']))
                    ...
                    @if(Auth::check() && in_array(Auth::user()->usertype, ['admin', 'kasir']))
                        ...
                        <div class="mb-4">
                            ...
                            <div class="input-group">
                                ...
                                <input type="number" name="no_hp" class="form-control" value="{{ old('no_hp') }}" placeholder="08xxxxxxxxxx">
                            </div>
                    ...
                    <div class="mb-4">
                        ...
                        @if(Auth::check() && in_array(Auth::user()->usertype, ['admin', 'kasir']))
                            ...
                            <div id="areaQR" class="alert alert-light border text-center mb-0 shadow-sm" style="display: none;">
                                ...
                                <small class="text-muted">Pembeli dapat melakukan scan QRIS pada halaman selanjutnya setelah Anda menekan tombol Konfirmasi.</small>
                            </div>
                        @else
                            {{-- KHUSUS PEMBELI ONLINE (HANYA QRIS) --}}
                            ...
                            <div class="alert alert-warning py-3 mb-0">
                                ...
                                <small>Pembayaran tunai/COD hanya tersedia jika Anda membeli langsung di toko kami.</small>
                            </div>
                        @endif
                    </div>
...
<script type="text/javascript">
    ...
    // 4. Efek Toggle QRIS (Khusus Kasir)
