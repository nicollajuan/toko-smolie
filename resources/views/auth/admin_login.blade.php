...
<head>
    ...
    <title>Login Staff - Smolie Gift</title>
    ...
    <div class="auth-card">
        <div class="row g-0">
            ...
            <div class="col-md-5 d-none d-md-flex left-side flex-column text-center" style="background-color: #FAFAFA;">
                ...
                {{-- Teks deskripsi diubah agar sesuai dengan peruntukan staf --}}
                <p class="text-muted small px-4">Portal khusus manajemen toko & kasir 🛠️</p>
            </div>
            ...
            <div class="col-md-7 right-side">
                ...
                {{-- Catatan: Form ini masih menembak route login bawaan. Jika nanti dibuat controller khusus, ubah route('login') ini --}}
                <form method="POST" action="{{ route('login') }}">
                    @csrf
                    
                    {{-- 1. EMAIL --}}
                    <div class="mb-4">
                        <label class="form-label">Email Staff <span>*</span></label>
                    ...
                    <button type="submit" class="btn-submit mb-4">Masuk ke Dashboard</button>
